  ...
  return (
    <main className="public-page">
      <article className="public-card">
        ...
        <p>Not Gmail uses Google sign-in to identify your email address and requests read-only Gmail access and sending permission. This allows the app to display messages, message bodies, attachments, labels, and mailbox counts, search your mail, and send messages you compose. It does not request permission to modify or delete existing Gmail messages.</p>
