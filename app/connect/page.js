    ...
    <main className="public-page">
      <article className="public-card">
        ...
        <ol>
          ...
          <li>Allow Not Gmail to read, send, and manage email.</li>
          <li>Return to your mailbox. Your messages and counts load from Gmail.</li>
        </ol>
        <p>We request your account email address and Gmail message management permission to read, send, and mark email as read. Opening a message alone leaves its read status unchanged. Use Mark all as read in the More menu to update Gmail, or select specific messages first.</p>
        <p>If you connected with read-only access before, reconnect and approve Gmail management permission. Then return to the mailbox and choose Mark all as read again. No messages are changed automatically after connecting.</p>
        {gmailConfigured() ? (
        ...
        <footer><a href="/privacy">Privacy &amp; your data</a> Â· <a href="/">Open mailbox</a></footer>
